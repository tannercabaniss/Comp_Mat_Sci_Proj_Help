...
param_grid_random = {
    'n_estimators': [10, 100, 1000, 10000],  # Number of trees
    'learning_rate': [0.001, 0.01, 0.1, 0.25, 0.5],  # Step size shrinkage
    'max_depth': [None, 5, 10, 20],  # Maximum depth of a tree
    'min_child_weight': [1, 2, 3],  # Minimum sum of instance weight (hessian) needed in a child
    'colsample_bytree': [0.5, 0.75, 1.0],  # Subsample ratio of columns when constructing each tree
    'gamma': [0.001, 0.01, 0.1, 0.5]  # Minimum loss reduction required to make a further partition on a leaf node of the tree
}

# Define the XGBoost base model with default hyperparameters
